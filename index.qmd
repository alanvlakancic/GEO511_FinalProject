...
ggmap(nyc_map) +
  geom_sf(data = osm_queens$osm_lines, inherit.aes = FALSE, color = "red", size = 0.5, alpha = 0.6) +
  geom_sf(data = shelters_sf_fix, inherit.aes = FALSE, color = "blue", size = 1)
...
ggsave(
  filename = "TBD/desire_lines_queens.png",
  plot = desire_plot,
